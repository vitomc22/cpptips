#include <iostream>
#include <iomanip> // lib para manipulação de dados , como set_precision, formata numeros do fluxo da string para 2  numeros após a virgula
...
int main()
{
	...
	for (auto Velocidade : Velocidades) // foreach
	{
